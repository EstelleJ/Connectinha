...
class Customer
{
    ...
    public function setStreetNb(string $street_nb): self
    {
    ...
    {
        return $this->street_name_2;
    }

    public function setStreetName2(?string $street_name_2): self
    {
