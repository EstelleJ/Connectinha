 ...
 */
final class Version20211112101301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mantra_products (id INT AUTO_INCREMENT NOT NULL, mantra VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mantra_products_product DROP FOREIGN KEY FK_E6939B3E835D1153');
        $this->addSql('DROP TABLE mantra_products');
